...
public class SocketChannelIOHelper_readTest_2_Test {
  @Test
  public void readTest() throws Exception {
    ...
    AbstractWrappedByteChannel channel = new AbstractWrappedByteChannel(
        new AbstractWrappedByteChannel(new AbstractWrappedByteChannel((ByteChannel) null)));

    // Act and Assert
    thrown.expect(NullPointerException.class);
    SocketChannelIOHelper.read(buf, ws, channel);
  }
  @Rule
